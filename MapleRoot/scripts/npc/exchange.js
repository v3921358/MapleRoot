...
function start() {
    cm.sendNext("If you believe you are ready to get one of the crystal stones i have in my posession look at me in the eye.");
}
...
function action(mode, type, selection) {
    if (mode < 1) {
        ...
        status++;
        if (status == 1) {
            cm.sendSimple("Well well well... what crystal are you looking for? \r\n#L0# #v4033446:# #k#l\r\n#L1# #v4033442:# #k#l\r\n#L2# #v4033450:# #k#l");
        } else if (status == 2) {
            if (selection == 0) {
