...
var exped = ExpeditionType.PAPULATUS;
var expedName = "Papulatus";
var expedBoss = "Papulatus";
var expedMap = "Origin of Clocktower";
...
function action(mode, type, selection) {
    ...
    em = cm.getEventManager("PapulatusBattle");
