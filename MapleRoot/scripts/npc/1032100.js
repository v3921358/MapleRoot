...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            if (cm.getLevel() >= 40) {
                cm.sendNext("Yeah... I am the master alchemist of the fairies. But the fairies are not supposed to be in contact with human beings for a long period of time... A strong person like you will be fine, though. If you get me the materials, I'll make you a special item.");
            } else {
