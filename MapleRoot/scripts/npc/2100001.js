...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendOk("Hi, thank you for coming by, but I have #rretired from refining ores#k. Please go to #b#eKibbles#n#k in the #bFree Market#k, she has been my apprentice for many years and has since \r\n#esurpassed me in refining all types of ores and jewels#n. She can even #renhance advanced equipment#k for you when crafting. \r\nI'm so proud of who she's become.");
