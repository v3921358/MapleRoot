        ...
        if (cm.getPlayer().getMapId() == 980000010) {
            ...
            if (status == 0) {
                ...
                if (select == 0) {
                    ...
                    if (cm.haveItem(4001129, n2) && cm.canHold(4001129)) {
                ...
                if (allDone) {
                    ...
                    cm.sendOk("Done. Be aware some of the items #rcould not be synthetized#k because either you have a lack of space in your ETC inventory or there's not enough mesos to cover the fee.");
                }
                cm.dispose();
            }
        }
